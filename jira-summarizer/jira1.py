...
#     predictor("DEX-1234")
#     # jiraClient = JIRA(token_auth="MzAzMDg4OTE1NTkyOsPfED+QBWo7ppiBp9hGqRQJIgU6", server="https://jira.cloudera.com")
#     # issue = jiraClient.issue(jira_id, fields='summary,comment')
#     # print(issue)

#predictor("DEX-1234")# Import dependencies
